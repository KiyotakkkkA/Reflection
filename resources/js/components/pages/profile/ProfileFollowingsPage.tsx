...
const ProfileFollowingsPage = observer(() => {
    ...
    const { data: followingsData, isPending: followingsIsPending } = useFollowings(username as string);
