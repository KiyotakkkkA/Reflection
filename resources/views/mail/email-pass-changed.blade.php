...
<head>
    <meta charset="UTF-8">
    <title>Уведомление о смене пароля — Reflection</title>
</head>
        ...
        <tr>
            <td style="padding: 0 24px 24px;">
                ...
                <p style="font-size: 1rem; color: #374151; margin-bottom: 24px;">
                    Мы хотим уведомить вас о недавных действиях с вашим аккаунтом в сервисе <strong>Reflection</strong>.
                </p>

                <div style="text-align: center; margin-bottom: 24px;">
                    <p style="font-size: 1.25rem; font-weight: bold; color: #111827; margin: 0;">Пароль был успешно изменён</p>
                </div>

                <p style="font-size: 0.875rem; color: #6B7280; margin-bottom: 0;">Если вы не меняли пароль, немедленно свяжитесь с нашей службой поддержки.</p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 24px;">
                <div style="border-left: 4px solid #F59E0B; background-color: #FEF3C7; padding: 12px 16px; border-radius: 4px;">
                    <p style="color: #92400E; font-size: 0.875rem; margin: 4px 0;">Если вы не запрашивали изменение пароля, обязательно сообщите об этом нам в службу поддержки.</p>
                    <p style="color: #92400E; font-size: 0.875rem; margin: 4px 0;">Для защиты аккаунта рекомендуем использовать надежные пароли и включить двухфакторную аутентификацию.</p>
                </div>
            </td>
        </tr>
