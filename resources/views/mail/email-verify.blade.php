...
<head>
    <meta charset="UTF-8">
    <title>Код подтверждения — Reflection</title>
</head>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); overflow: hidden;">
        <tr>
            <td align="center" style="padding: 24px 0;">
                <h1 style="font-size: 1.5rem; font-weight: 600; color: #111827; margin-top: 16px; margin-bottom: 0;">Добро пожаловать в Reflection</h1>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 0 24px 24px;">
                ...
                <p style="font-size: 1rem; color: #374151; margin-bottom: 24px;">
                    Спасибо за регистрацию в сервисе <strong>Reflection</strong>. Ниже представлен ваш код подтверждения email.
                </p>

                <div style="background-color: #F9FAFB; border-radius: 8px; padding: 16px; text-align: center; margin-bottom: 24px;">
                    <p style="font-size: 1.25rem; font-weight: bold; color: #111827; margin: 0;">{{ $code }}</p>
                </div>

                <p style="font-size: 0.875rem; color: #6B7280; margin-bottom: 0;">Этот код действителен в течение 5 минут.</p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 24px;">
                <div style="border-left: 4px solid #F59E0B; background-color: #FEF3C7; padding: 12px 16px; border-radius: 4px;">
                    <p style="color: #92400E; font-size: 0.875rem; margin: 4px 0;">Если вы не регистрировались в сервисе, просто проигнорируйте это письмо.</p>
                    <p style="color: #92400E; font-size: 0.875rem; margin: 4px 0;">Не передавайте этот код никому — он конфиденциален.</p>
                </div>
            </td>
        </tr>
